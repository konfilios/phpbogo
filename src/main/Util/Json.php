 ...
 * <ul>
 * <li>JSON string validation: Util\Json::isValid()</li>
 * <li>JSON formatting/indentation: Util\Json::indent()</li>
 * <li>JSON soft decoding: Util\Json::softDecode*() (<i>does not fail if json is invalid</i>)</li>
 * </ul>
 *
 * @since 1.0
 * @package Components
...
class Json
{
	...
	static public function decodeAssoc($jsonInput)
	{
		...
		if (($objectOutput === null) && ($jsonInput !== 'null')) {
			// Json_decode failed
			throw new \Exception('Could not JSON-decode input object');
		}
