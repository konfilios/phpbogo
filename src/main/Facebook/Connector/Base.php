...
abstract class Base
{
   ...
   * The cookie is not set by the Base class, but
   ...
   * metadata. The cookie is not set by the Base class, but it may be
  ...
  /**
   * Get the data for $key, persisted by Base::setPersistentData()
   *
